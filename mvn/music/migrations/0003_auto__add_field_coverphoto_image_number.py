...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoverPhoto.image_number'
        db.add_column('music_coverphoto', 'image_number',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoverPhoto.image_number'
        db.delete_column('music_coverphoto', 'image_number')
    ...
    models = {
        'music.coverphoto': {
            ...
            'image_number': ('django.db.models.fields.SmallIntegerField', [], {}),
